...
//switch statement to direct next action based on users choice
    .then((response) => {
        if(response.actionFromMain === "Quit") {
            ...
            console.log(`Dep_id   Title          Salary    Department\n************************************\n${results[2].id}   ${results[2].title}       ${results[2].salary}   ${results[2].department_name}\n${results[3].id}   ${results[3].title}   ${results[3].salary}   ${results[3].department_name}\n${results[4].id}   ${results[4].title}    ${results[4].salary}   ${results[4].department_name}\n${results[5].id}   ${results[5].title}          ${results[5].salary}   ${results[5].department_name}\n${results[6].id}   ${results[6].title}     ${results[6].salary}   ${results[6].department_name}\n${results[7].id}   ${results[7].title}              ${results[7].salary}   ${results[7].department_name}\n${results[0].id}   ${results[0].title}          ${results[0].salary}   ${results[0].department_name}\n${results[1].id}   ${results[1].title}        ${results[1].salary}    ${results[1].department_name}`);
            return mainPrompt();
        });
        } else {
